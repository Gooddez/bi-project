...
function clearResults() {
    ...
    document.getElementById("insightsGrid").innerHTML =
        `<div class="empty-state" style="padding:20px 0"><div class="empty-icon">✨</div><div class="empty-text">Finding insights...</div></div>`;
    document.getElementById("chartContainer").innerHTML =
        `<div class="empty-state"><div class="empty-icon">📊</div><div class="empty-text">Building chart...</div></div>`;
